...
function artboards(context) {
  ...
  if (renamedArtboardsCounter === 0) {
    doc.showMessage('All artboard titles is perfect'); //console.log('All artboard titles is perfect');
  } else {
    doc.showMessage(renamedArtboardsCounter + ' artboards has been renamed'); //console.log(renamedArtboardsCounter + ' artboards renamed');
  }
}
; //artboards(context);
